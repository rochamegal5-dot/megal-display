        ...
        {data ? (
          <>
            <div className="result-column">
              ...
              <small className="result-date">{data.fechaVespertina || data.fecha || 'Último resultado disponible'}</small>
            ...
            <div className="result-column">
              ...
              <small className="result-date">{data.fechaNocturna || data.fecha || 'Último resultado disponible'}</small>
